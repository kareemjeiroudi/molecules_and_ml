...
* Either [Theano](http://deeplearning.net/software/theano/install.html) or [Tensorflow](https://www.tensorflow.org/versions/r0.10/get_started/os_setup.html) engine. In my case, I used Tensorflow. Make sure you have tensforflow 1 not 2, since tensorflow no longer exposes sessions, but relies rather on eager execution. The implementation still uses computed graphs.
